...
G4VPhysicalVolume* EEShashDetectorConstruction::DefineVolumes()
{
  ...
  */
  ...
  // Scintillator 30x30x4mm:
  G4double scintSizeXY = 30.*mm;
  G4double scintLength = 5.*mm;
...
void EEShashDetectorConstruction::ConstructSDandField()
{
  ...
  EEShashCalorimeterSD* absSD 
    = new EEShashCalorimeterSD("AbsSD", "AbsHitsCollection", fNofLayers*9,1);
  SetSensitiveDetector("AbsLV",absSD);

  EEShashCalorimeterSD* actSD 
    = new EEShashCalorimeterSD("ActSD", "ActHitsCollection", fNofLayers*9,1);
