...
if [ $# -ne 6 ] && [ $# -ne 7 ] ; then
    echo "USAGE: ./simulation_750MeV_batch.sh [full/clean/root] beamEnergy nLayers activeLayerThickness absorberLayerThickness transverseCellSize particleImpactPosition[=0mm]"
    exit
fi
