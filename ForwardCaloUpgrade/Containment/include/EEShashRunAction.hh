...
class EEShashPrimaryGeneratorAction;
...
{
public:
  EEShashRunAction(EEShashDetectorConstruction* );
...
private:
  ...
  EEShashDetectorConstruction*   fDet;
...
inline
void EEShashRunAction::FillPerStep(G4double dEstep, G4int Lbin, G4int Rbin)
{
